#Program 3: Simulate to study transmission of packets over Ethernet LAN and determine the number of packets drop destination.
...
END {
	printf("\nNumber of packets dropped at the destination node 4: %d", c);
	printf("\nNumber of packets dropped at the destination node 5: %d", c1);
}
